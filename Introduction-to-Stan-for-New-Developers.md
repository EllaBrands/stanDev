...
There are a lot of files that are in our `.gitignore` file that stack up and don't get cleaned. In order to remove every untracked file, including hidden ones, do this:
