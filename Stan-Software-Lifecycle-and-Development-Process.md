...
follow the [R regulatory compliance and validation document](https://www.r-project.org/doc/R-FDA.pdf).
...
issues are discussed and prioritized.  They are not recorded or stored.
...
meetups for the public in locations including Berlin, Boston, London,
Sydney, and New York.
...
Git](https://nvie.com/posts/a-successful-git-branching-model/).  The
main image from that post is reproduced here,

![Git Process image, (c) Vincent Driessen 2010](https://nvie.com/img/git-model@2x.png)
